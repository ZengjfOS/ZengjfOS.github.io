...
class HandTurnPage:
    ...
    @model(docs/ipynb/0029_HandTurnPage/HandTurnPage.hdf5): model
    @test(default/HandTurnPage.txt): text
    @label(docs/ipynb/0029_HandTurnPage/label.csv): label
    """
